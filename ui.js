"use strict";
    ...
    const SHAPE_SCALE_OVERRIDE = { guardTrooper: HERO_BATTLE_SCALE, laborEnforcer: HERO_BATTLE_SCALE, riotShieldTrooper: HERO_BATTLE_SCALE, humanoidOfficerVossmark: HERO_BATTLE_SCALE, humanoidOfficerTalos: HERO_BATTLE_SCALE, spliceWither: HERO_BATTLE_SCALE, bioRupture: HERO_BATTLE_SCALE, chimeraFusion: HERO_BATTLE_SCALE, poltergeistWisp: HERO_BATTLE_SCALE, shadeWraith: HERO_BATTLE_SCALE, terrorMaw: HERO_BATTLE_SCALE, abyssalClaw: HERO_BATTLE_SCALE, demonBrand: HERO_BATTLE_SCALE, devilCrown: HERO_BATTLE_SCALE, voraxxFat: 4, wardenCore: 4, proteusBloom: 3, voidSoulEaterMaw: 4, sunGodEclipse: 4, phthoraWreck: 3, cagedGodCocoon: 4, chthonBreach: 3, hiveLord: 3, heavyMech: 8 };
